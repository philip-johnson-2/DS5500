...
select patient_id,
	...
	-- er visits
	MAX(case when event_name = 'ED Visit' AND event_date between '2024-06-30' and '2025-06-30' then 1 else 0 end),
	MAX(case when event_name = 'ED Visit' AND event_date between '2024-12-31' and '2025-06-30' then 1 else 0 end),
	MAX(case when event_name = 'ED Visit' AND event_date between '2025-03-30' and '2025-06-30' then 1 else 0 end),
	MAX(case when event_name = 'ED Visit' AND event_date between '2025-05-30' and '2025-06-30' then 1 else 0 end),
	-- pcp visits 
